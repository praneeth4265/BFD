...
Output:
- project_reports/ensemble_eval/model_reports/ensemble_detailed_report.pdf
"""
...
RESULTS_PATH = Path("project_reports/ensemble_eval/ensemble_results.json")
WEIGHT_OPT_PATH = Path("project_reports/ensemble_eval/weight_optimization_results.json")
BASE_DIR = Path("project_reports/ensemble_eval")
OUTPUT_DIR = BASE_DIR / "model_reports"
