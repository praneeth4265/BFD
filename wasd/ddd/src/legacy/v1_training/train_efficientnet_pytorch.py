"""
PyTorch Training Script - EfficientNetV2-S
...
print("="*80)
print("🚀 PYTORCH EFFICIENTNET V2-S TRAINING")
print("="*80)
...
print("🏗️  BUILDING EFFICIENTNET V2-S MODEL")
print("="*80)
...
for epoch in range(CONFIG['epochs']):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), MODEL_DIR / 'efficientnet_v2_best.pth')
...
model.load_state_dict(torch.load(MODEL_DIR / 'efficientnet_v2_best.pth'))
...
with open(MODEL_DIR / 'efficientnet_v2_results.json', 'w') as f:
    json.dump(results, f, indent=2)

print(f"✅ Results saved to: {MODEL_DIR / 'efficientnet_v2_results.json'}")
print(f"✅ Best model saved to: {MODEL_DIR / 'efficientnet_v2_best.pth'}")
print()
print("="*80)
