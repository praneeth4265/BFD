"""
PyTorch Training Script - Swin Transformer on 3-Class Augmented Dataset
Hierarchical Vision Transformer with shifted window attention
Model: Swin-Tiny (ImageNet pretrained)
...
print("="*80)
print("🚀 PYTORCH SWIN TRANSFORMER TRAINING - 3-CLASS AUGMENTED DATASET")
print("="*80)
...
# Build model
print("🏗️  Building Swin-Tiny model...")
print("   Architecture: Hierarchical Vision Transformer with Shifted Windows")
...
for epoch in range(CONFIG['epochs']):
    ...
    if val_acc > best_val_acc:
        ...
        if CONFIG['save_best_only']:
            model_path = MODEL_DIR / 'swin_3class_augmented_best.pth'
            torch.save({
                'epoch': epoch + 1,
...
results = {
    ...
    'architecture': 'Hierarchical Vision Transformer (Swin)',
    'num_classes': CONFIG['num_classes'],
...
results_path = MODEL_DIR / 'swin_3class_augmented_results.json'
