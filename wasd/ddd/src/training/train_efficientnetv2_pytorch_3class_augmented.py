"""
PyTorch Training Script - EfficientNetV2 on 3-Class Augmented Dataset
...
print("="*80)
print("🚀 PYTORCH EFFICIENTNETV2 TRAINING - 3-CLASS AUGMENTED DATASET")
print("="*80)
...
for epoch in range(CONFIG['epochs']):
    ...
    if val_acc > best_val_acc:
        ...
        if CONFIG['save_best_only']:
            model_path = MODEL_DIR / 'efficientnetv2_3class_augmented_best.pth'
            torch.save({
                'epoch': epoch + 1,
...
results_path = MODEL_DIR / 'efficientnetv2_3class_augmented_results.json'
