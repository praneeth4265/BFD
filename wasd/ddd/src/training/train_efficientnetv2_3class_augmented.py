"""
Train EfficientNetV2-S on 3-Class Augmented Dataset
...
def main():
    ...
    print("="*80)
    print("🎯 TRAINING EFFICIENTNETV2-S - 3-CLASS (AUGMENTED DATASET)")
    print("="*80)
    print()
    ...
    config = {
        ...
        'img_size': 224,  # Reduced from 384 to fit in GPU memory
        'batch_size': 24,  # Increased since smaller images
        'epochs': 30,
        'learning_rate': 1e-4,
        'model_name': 'efficientnetv2_3class_augmented',
    ...
    results_file = Path(__file__).parent / 'models' / 'checkpoints' / f"{config['model_name']}_results.json"
