"""
PyTorch Training Script - ConvNeXt V2 on 3-Class Augmented Dataset
...
print("="*80)
print("🚀 PYTORCH CONVNEXT V2 TRAINING - 3-CLASS AUGMENTED DATASET")
print("="*80)
...
CONFIG = {
    ...
    'img_size': 224,
    'batch_size': 16,  # Reduced from 32 to fit 87M parameter model in GPU
    'learning_rate': 1e-4,
    'epochs': 30,
    'num_classes': 3,
    'num_workers': 4,
...
for epoch in range(CONFIG['epochs']):
    ...
    if val_acc > best_val_acc:
        ...
        if CONFIG['save_best_only']:
            model_path = MODEL_DIR / 'convnextv2_3class_augmented_best.pth'
            torch.save({
                'epoch': epoch + 1,
...
results_path = MODEL_DIR / 'convnextv2_3class_augmented_results.json'
