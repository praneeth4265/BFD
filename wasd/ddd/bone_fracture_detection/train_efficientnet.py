"""
Main Training Script - EfficientNetV2-S
High-performance training with maximum GPU utilization
"""

import os
os.environ['TF_CPP_MIN_LOG_LEVEL'] = '2'  # Reduce TensorFlow logging
# Set CUDA paths for TensorFlow to find CUDA toolkit
...
from train_efficientnet_v2 import EfficientNetV2Trainer
...
def main():
    """Main training pipeline for EfficientNetV2-S"""
    ...
    print("\n" + "="*80)
    print("⚙️  TRAINING CONFIGURATION - EFFICIENTNETV2-S")
    print("="*80)
    ...
    # Save history
    history_path = models_path / f'efficientnetv2s_history_{timestamp}.json'
    trainer.save_history(history_path)
    
    # Save test results
    results_path = models_path / f'efficientnetv2s_results_{timestamp}.json'
    ...
    print(f"\n📁 Saved Files:")
    print(f"   Best Model: {models_path / 'efficientnetv2s_best.h5'}")
...
if __name__ == "__main__":
    try:
        ...
        print("\n✅ SUCCESS! EfficientNetV2-S training completed successfully!")
