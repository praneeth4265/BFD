"""
PyTorch Training Script - ConvNeXt V2 (IMPROVED WITH REGULARIZATION)
...
print("="*80)
print("🚀 PYTORCH CONVNEXT V2 TRAINING (IMPROVED - ANTI-OVERFITTING)")
print("="*80)
...
print("🏗️  BUILDING CONVNEXT V2 MODEL WITH REGULARIZATION")
print("="*80)
...
for epoch in range(CONFIG['epochs']):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save({
            ...
            'val_acc': val_acc,
            'config': CONFIG
        }, MODEL_DIR / 'convnext_v2_improved_best.pth')
...
checkpoint = torch.load(MODEL_DIR / 'convnext_v2_improved_best.pth')
...
with open(MODEL_DIR / 'convnext_v2_improved_results.json', 'w') as f:
    json.dump(results, f, indent=2)

print(f"✅ Results saved to: {MODEL_DIR / 'convnext_v2_improved_results.json'}")
print(f"✅ Best model saved to: {MODEL_DIR / 'convnext_v2_improved_best.pth'}")
print()
print("="*80)
